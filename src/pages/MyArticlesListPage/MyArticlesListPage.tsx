        ...
        myArticlesList.length ?
            <div>
                <div className='flex justify-center mb-7'>
                    <Link to={`${window.origin}/post/create`} className="py-2.5 px-5 mr-2 w-48 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center justify-center">
                        Add new article
                    </Link>
                </div>
                <List
