...
const EditArticlePage: FC = () => {
    ...
    const [currentPost] = useState<IPost[]>([...articles.filter((article: IPost) => article._id === id)]);
    ...
    const onSubmit = async (data: {}) => {
        if (id && data && token) {
            ...
            try {
                const response = await updateOneArticlePost(id, data, token);
                if(response) { 
                    navigate(`/post/${id}`);
                }
            } catch (e) {
        ...
        <div className='new_article_page__container'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='title_input pb-7'>
                    ...
                    <input defaultValue={currentPost[0]?.title} id='title' type="text" aria-describedby="helper-text-title" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write article title here..."
                        {...register("title", {
                ...
                <div className='text_input pb-7'>
                    ...
                    <textarea defaultValue={currentPost[0]?.text} id="text" rows={6} aria-describedby="helper-text-text" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write article text here..."
                        {...register("text", {
                ...
                <div className='tags_input pb-7'>
                    ...
                    <input defaultValue={currentPost[0]?.tags} id='tags' type="text" aria-describedby="helper-text-tags" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Input tags..."
                        {...register("tags")} />
                </div>
