...
export const MenuAdditional = ({
  ...
  return (
    <div className={classList}>
      ...
      {dropdownOpened && post && (
        <div className="z-10 top-full mt-3 absolute right-0 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
